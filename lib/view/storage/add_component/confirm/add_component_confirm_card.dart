...
class AddComponentConfirmCard extends StatelessWidget {
  const AddComponentConfirmCard({super.key, required this.component});
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              SupabaseDatabaseController.categoryMapCached[component
                      .categoryID]['name'] ??
                  "Khác",
              style: TextStyle(
